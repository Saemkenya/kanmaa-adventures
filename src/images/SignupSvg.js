...
const SignupSvg = (props) => {
  return (
    ...
    >
      ...
      <title>Sign Up to Kanmaa Adventures</title>
      <path
        ...
        opacity="0.1"
      />
      <circle cx="174.08" cy="129.4" r="31.5" fill="#6c63ff" opacity="0.1" />
      <circle cx="108.09" cy="54.4" r="19.5" fill="#6c63ff" opacity="0.1" />
      <circle cx="925.57" cy="114.4" r="12" fill="#6c63ff" opacity="0.1" />
      <ellipse
        cx="689.92"
        cy="788.85"
        rx="84.24"
